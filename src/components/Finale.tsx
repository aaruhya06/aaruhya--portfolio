...
const Finale = () => {
  ...
  const marqueeTags = [
    "Aaruhya Kumar 🚀",
    "Full Stack Dev | React.js | Node.js | Systems Architect",
    "Designing clean UI/UX + Purposeful Solutions🔖",
    "Aaruhya Portfolio 2026",
  ];
