...
const experiences = [
  {
    role: "Co-founder & Freelancer",
    company: "CyberMonkStudioz",
    period: "[2025 – PRESENT]",
    description: "🚀 Architecting digital disruption. Transforming high-concept ideas into high-performance reality with a blend of radical creativity and technical precision."
  },
  {
